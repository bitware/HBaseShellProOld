...
HBaseShellPro is a powerful Hbase Shell extention. It provide more commond then default hbase shell.

1. Can use filter in all commond
2. Can use Regular Expression in commond parameter
3. More simple more light then hbase shell
